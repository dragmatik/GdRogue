...
func shoot() -> void:
	for i in range(3):
		var rock_scene: PackedScene = preload("res://Scenes/Enemies/Attacks/Rocks_xy.tscn")
		var rock: Node2D = rock_scene.instantiate()
		get_parent().add_child(rock)
		rock.global_position = attack_marker.global_position
