...
# Ranged Projectile
var projectile_direction = false # right is true, left is false
func shoot():
	var projectile = preload("res://Scenes/Enemies/Attacks/Projectile_x.tscn")
